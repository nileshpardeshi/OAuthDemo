...
public class OauthTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver", "D:\\Nilesh Professional World\\My Practice\\AutomationProject\\Drivers\\all\\chromedriver.exe");
		...
		driver.findElement(By.cssSelector("[type='email']")).sendKeys("nileshpardeshi2507@gmail.com");
